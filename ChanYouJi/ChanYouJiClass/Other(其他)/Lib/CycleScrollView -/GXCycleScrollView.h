...
@class GXCycleScrollView;

@protocol GXCycleScrollViewDelegate <NSObject>
...
@interface GXCycleScrollView : UIView
...
// 代理
@property (nonatomic ,weak) id <GXCycleScrollViewDelegate> delegate;
